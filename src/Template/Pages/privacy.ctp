<div class="container">
    <div class="row">
        ...
        <div class="col-md-10 center" style="margin-top: 2em; text-align: left;">
            株式会社ティピカル・ジャパン（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。<br/>
            <br/>
            第1条（プライバシー情報）<br/>
            <br/>
            ...
            <br/>
            住所：東京都渋谷区桜丘町29-24　秀和桜丘レジデンス510<br/>
            社名：株式会社ティピカル・ジャパン<br/>
            担当部署：代表取締役　<br/>
            Eメールアドレス：kenjinkai@typical-japan.com<br/>
        </div>
    </div>
</div>