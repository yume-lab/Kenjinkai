...
class InformationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'information_type_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'path' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'is_deleted' => 1,
            'created' => '2016-01-29 07:24:48',
            'modified' => '2016-01-29 07:24:48'
        ],
    ];
}
